package com.example.javatest.myreflex.map;
...
public class MyLinkedHashMap<K, V> extends MyHashMap<K, V> implements Map<K, V> {
     ...
     *
     * MyLinkedHashMap.Entry<K, V> entry = map.entrySet().iterator.next()
     *
     * To compile, that code snippet's "MyLinkedHashMap.Entry" must
